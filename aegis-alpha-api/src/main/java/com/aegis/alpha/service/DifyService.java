...
public class DifyService {
    ...
    public DifyService(@Value("${aegis.dify.enabled:false}") boolean enabled,
                       @Value("${aegis.dify.base-url:https://api.dify.ai/v1}") String baseUrl,
                       @Value("${aegis.dify.workflow-api-key:}") String workflowApiKey,
                       @Value("${aegis.dify.chat-api-key:}") String chatApiKey) {
