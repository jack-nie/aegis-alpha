...
import com.marketmind.alpha.service.WorkflowNodeExecutionService;
...
public class WorkflowNodeExecutionController {
    ...
    @PostMapping("/execute")
    public ResponseEntity<Map<String, Object>> execute(@RequestHeader(value = "X-MarketMind-Workflow-Token", required = false) String token,
