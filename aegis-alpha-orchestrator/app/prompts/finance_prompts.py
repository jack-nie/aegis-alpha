...
class PromptManager:
    ...
    _prompts: dict[str, str] = {
        ...
        "finance.stock_recommendation_aggregate": (
            "Generate a comprehensive investment research report for {subject}.\n\n"
            "## Required Sections\n\n"
            "### 1. Company Overview\n"
            "Brief description, industry, market cap, key metrics.\n\n"
            "### 2. Market & Valuation\n"
            "Current price, P/E, P/B, dividend yield, 52-week range.\n\n"
            "### 3. Technical Analysis\n"
            "MA trends, RSI, MACD, support/resistance levels.\n\n"
            "### 4. Fundamental Analysis\n"
            "Revenue, earnings, margins, growth rates, ROE.\n\n"
            "### 5. Key Risks\n"
            "List 3-5 major risks with specific details.\n\n"
            "### 6. Summary & Recommendation\n"
            "Clear buy/hold/sell recommendation with target price.\n\n"
            "Use ACTUAL data values from the context. Do NOT say 'data insufficient'. "
